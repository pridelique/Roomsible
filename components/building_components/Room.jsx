...
function Room({ roomNumber, name, status, col_span, handleOnClick, showName }) {
  ...
  return (
    <div 
        ...
        className='w-full'
    >
        <div className={`relative z-1 bg-gray-200 rounded-md shadow-sm  flex justify-center items-center text-center text-sm w-full h-full p-1 transition-all duration-200 ease-in-out
        ${status === "none" ? 'hidden' : ''}
