...
function Profile({ handleLogout }) {
  ...
  return (
    <div className="relative">
      <button
        className="flex items-center justify-center cursor-pointer opacity-50 hover:opacity-80 focus:opacity-100  transition-all duration-200"
      ...
      {profileDropdown && (
        <div className="absolute w-42 right-0 top-full bg-white shadow-md text-[16px] rounded-lg z-10 overflow-hidden border border-gray-300 text-slate-gray" ref={dropdownRef}>
          <ul>
            <li className="hover:bg-gray-100 active:bg-gray-200">
