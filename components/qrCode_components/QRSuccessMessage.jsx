...
function QRSuccessMessage({ success }) {
  return (
    <div className="absolute top-1/2 left-1/2 -translate-1/2 bg-white text-white pb-4 rounded-xl z-3 shadow-lg text-center w-full max-w-[340px] flex flex-col justify-center items-center ">
      ...
      <div className="px-8 flex flex-col justify-center items-center w-full mt-1">
        <h3 className="text-2xl text-green-500 mt-3 font-semibold">
          เช็คอินสำเร็จ
        </h3>
        ...
        <Link
          href="/"
          className="text-lg text-white bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br focus:outline-none shadow-green-500/50 shadow-sm text-center cursor-pointer py-2 w-4/5 rounded-2xl mt-6"
        >
          กลับไปหน้าแรก
        </Link>
      </div>
