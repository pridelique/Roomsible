        ...
        <div className="relative mx-auto max-w-4xl ">
          ...
          <div className="relative max-w-4xl mx-auto flex flex-col">
            ...
            <div className="min-[460px]:px-4">
              <div className="bg-white min-[460px]:my-4 max-[460px]:mt-1 py-6 min-[460px]:rounded-3xl min-[460px]:shadow-lg">
              ...
              /> */}
                ...
                <div className="flex flex-col max-[520px]:flex-col-reverse items-center justify-center">
                  ...
                  <PageSelector
                    ...
                    bookingsLoading={bookingsLoading}
                  />
                  <div className="mt-3 max-[520px]:mb-0 px-4 relative w-full">
