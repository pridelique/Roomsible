...
function BookingForm()
{
    ...
    return (
        <div className="bg-white p-15 rounded-3xl shadow-md w-full max-w-md mx-auto border border-gray-300">
            <h2 className="text-3xl font-semibold text-center mb-2 text-gray-700">ห้อง {roomNumber}</h2>
            <p className="text-center mb-7 text-gray-600 text-lg">คาบที่ {period}  ({timeSlots[period].from} - {timeSlots[period].to} น.)</p>
